	...
	if (Interface_Bruteforce.Get_Integer() == 1)
	{
		...
		if (Entity != Get_Local_Player())
		{
			...
			if (Player_Data->Priority != -2)
			{
				...
				Set_Pose_Parameter_Type((unsigned __int64)Set_Pose_Parameter)(Entity, Studio_Header, *(__int32*)((unsigned __int64)Animation_State + 72), __builtin_remainderf(*(float*)((unsigned __int64)Animation_State + 136) - *(float*)((unsigned __int64)Animation_State + 60), 360.f));
