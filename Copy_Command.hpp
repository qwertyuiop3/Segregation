...
void Copy_Command(void* Unknown_Parameter, Command_Structure* Command, void* Frame_Address)
{
	...
	if (*(__int8*)((unsigned __int64)Local_Player + 199) == 0)
	{
		...
		*(__int8*)((unsigned __int64)Prediction + 12) = 0;
		...
		if (Bullets_Fired == 0)
		{
			void* Weapon = *(void**)((unsigned __int64)Client_Module + 9532984 + ((*(unsigned __int32*)((unsigned __int64)Local_Player + 10560) & 16383) << 5));
										...
										if (Hitbox != nullptr)
										{
															...
															if (Extrapolation_Windows > 0)
															{
																if (*(__int32*)((unsigned __int64)Target->Self + 11452) == -1)
																{
																	...
																	if (__builtin_sqrtf(__builtin_powf(Previous_Velocity[0], 2.f) + __builtin_powf(Previous_Velocity[1], 2.f) + __builtin_powf(Previous_Velocity[2], 2.f)) >= 1.f)
																	{
																		...
																		Set_Ground_Entity_Type((unsigned __int64)Set_Ground_Entity)(Target->Self, (Previous_Flags & 1) == 1 ? *(void**)((unsigned __int64)Client_Module + 9462456) : nullptr);
											...
											if (Setup_Bones_Type((unsigned __int64)Setup_Bones)((void*)((unsigned __int64)Target->Self + 8), Bones, 128, 524032, Global_Variables->Current_Time) == 1)
											{
												auto Trace_Ray = [&](float Direction[3]) -> __int8
												{
													...
													Trace_Ray_Type((unsigned __int64)Trace_Ray)((void*)((unsigned __int64)Engine_Module + 5022592), &Ray, 1174421507, &Filter, &Trace);
