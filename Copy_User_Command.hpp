...
void __thiscall Redirected_Copy_User_Command(void* Unknown_Parameter, User_Command_Structure* User_Command)
{
	if (__builtin_return_address(0) == (void*)((unsigned __int32)Client_Module_Location + 1340913))
	{
		...
		if (*(__int32*)((unsigned __int32)Engine_Module_Location + 3935044) != 1)
		{
			...
			Update_Type(605209712)(Prediction, 1, 1, *(void**)((unsigned __int32)Engine_Module_Location + 4702952), *(__int32*)((unsigned __int32)Engine_Module_Location + 4702944) + *(__int32*)((unsigned __int32)Engine_Module_Location + 4702948));
		}
		...
		if (*(__int8*)((unsigned __int32)Local_Player + 147) == 0)
		{
			auto Angle_Vectors = [](float* Angles, float* Forward, float* Right, float* Up) -> void
			{
				...
				Angle_Vectors_Type((unsigned __int32)Client_Module_Location + 2568048)(Angles, Forward, Right, Up);
			};
			...
			if ((User_Command->Buttons & 2) == 2)
			{
				...
				{
					User_Command->Buttons &= ~(*(__int32*)((unsigned __int32)Local_Player + 376) & 2);
				}
				else
				{
					User_Command->Buttons &= ~(*(__int32*)((unsigned __int32)Local_Player + 4120) & 2);
				}
			...
			auto Vector_Normalize = [](float* Vector) -> float
			{
				...
				return Vector_Normalize_Type((unsigned __int32)Client_Module_Location + 2565744)(Vector);
			};
			...
			void* Previous_Audio_Device = *(void**)((unsigned __int32)Engine_Module_Location + 4334668);

			*(void**)((unsigned __int32)Engine_Module_Location + 4334668) = nullptr;
			...
			*(float*)((unsigned __int32)Local_Player + 4728) = Previous_Friction;
			...
			__int32 Choked_Commands_Count = *(__int32*)((unsigned __int32)Engine_Module_Location + 4702944);
