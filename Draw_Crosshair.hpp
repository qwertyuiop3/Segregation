void Redirected_Draw_Crosshair()
{
	...
	auto Uber_Alles = [&](unsigned __int8 Red, __int32 X, __int32 Y)
	{
		...
		(*Set_Color_Type(*(unsigned __int32*)Surface + 60))(Surface, Red, 0, 0, 255);
	...
	Rotation_Angle = __builtin_remainderf(Rotation_Angle - (*(Global_Variables_Structure**)((unsigned __int32)Client_Module + 10871344))->Frame_Time * Interface_Uber_Alles_Speed.Get_Integer(), 180.f);
}