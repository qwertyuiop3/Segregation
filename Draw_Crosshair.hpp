void Redirected_Draw_Crosshair()
{
	*(__int32*)((unsigned __int32)Client_Module + 5190296) = 0;
	...
	auto Uber_Alles = [&](unsigned __int8 Red, __int32 X, __int32 Y)
	{
		...
		void* Surface = *(void**)((unsigned __int32)Client_Module + 5530696);
	...
	__int32 Screen_Width = Get_Screen_Size_Type((unsigned __int32)Client_Module + 878608)() / 2;

	__int32 Screen_Height = Get_Screen_Size_Type((unsigned __int32)Client_Module + 878576)() / 2;
	...
	Rotation_Angle = __builtin_remainderf(Rotation_Angle - (*(Global_Variables_Structure**)((unsigned __int32)Client_Module + 4825720))->Frame_Time * Interface_Uber_Alles_Speed.Integer, 180.f);
}