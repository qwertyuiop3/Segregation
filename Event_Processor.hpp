...
void Event_Processor(void* Unknown_Parameter, void* Event)
{
	...
	if (Local_Player != nullptr)
	{
		...
		if (Name[0] == 'p')
		{
			...
			__int32 Killer_Number = Identifier_To_Number_Type((unsigned __int64)Engine_Module + 459392)((void*)((unsigned __int64)Engine_Module + 4588960), Get_Integer_Type((unsigned __int64)Engine_Module + 1652944)(Event, (char*)"attacker", nullptr));
