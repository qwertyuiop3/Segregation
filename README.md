...
|`Second_Choked_Angle_Y`|Второй промежуточный угол горизонтального вращения тела относительно цели.<br>Используется для поддержания разницы ([`m_flLastTurnTime`](https://github.com/rom4s/hl2sdk-ep1c/blob/game-cstrike-1/game/shared/base_playeranimstate.cpp#L833-L837)) во время душения.|[-180.0, 180.0]|
