void Redirected_Send_Move()
{
	struct Message_Structure
	{
		...
		void Construct(__int8* Data, unsigned __int32 Size)
		{
			...
			*(void**)Message = (void*)((unsigned __int32)Engine_Module + 3091684);
	...
	__int32 Choked_Commands = *(__int32*)((unsigned __int32)Engine_Module + 4702944);
	...
	*(__int32*)((unsigned __int32)&Message + 16) = Backup_Commands;
	...
	__int32 Next_Command_Number = *(__int32*)((unsigned __int32)Engine_Module + 4702940) + Choked_Commands + 2;
	...
	Write_Command_Label:
	{
		...
		Write_Command_Type((unsigned __int32)Client_Module + 877552)(*(void**)((unsigned __int32)Engine_Module + 4566708), (void*)((unsigned __int32)&Message + 52), From_Command_Number, To_Command_Number, nullptr);
	...
	*(__int32*)((unsigned __int32)Network_Channel + 28) = 0;
	...
	Send_Network_Message_Type((unsigned __int32)Engine_Module + 1882928)(Network_Channel, &Message, nullptr, nullptr);
}