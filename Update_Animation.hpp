	...
	*(__int8*)((unsigned __int32)Player + 14817) = Update_Animation_Type;
	...
	else
	{
		...
		*(float*)(*(unsigned __int32*)((unsigned __int32)Player + 14452) + 108) = Global_Variables->Current_Time - Global_Variables->Interval_Per_Tick * max(1, Update_Animation_Delta[Update_Animation_Type - 1]);
		...
		float Initial_Animation_Layers[210];

		Byte_Manager::Copy_Bytes(1, Initial_Animation_Layers, sizeof(Initial_Animation_Layers), *(void**)((unsigned __int32)Player + 10608));
		...
		if (Update_Animation_Type == 1)
		{
			Byte_Manager::Copy_Bytes(1, *(void**)((unsigned __int32)Player + 10608), sizeof(Initial_Animation_Layers), Initial_Animation_Layers);
		}
		else
		{
